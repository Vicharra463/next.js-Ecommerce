    ...
    return (
        <div className="min-h-screen bg-zinc-900 relative overflow-hidden">
            ...
            <div className="absolute inset-0">
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-amber-300/3 rounded-full blur-3xl"></div>
            </div>
            
            <div className="relative z-10 px-4 py-16">
                {/* Hero Section */}
                <div className="max-w-4xl mx-auto text-center mb-16">
                    <div className="inline-flex items-center gap-2 bg-amber-500/10 backdrop-blur-sm rounded-full px-6 py-2 mb-6 border border-amber-300/20">
                        <Sparkles className="w-4 h-4 text-amber-400" />
                        <span className="text-amber-300 text-sm font-medium">Conoce Nuestra Historia</span>
                    </div>
                    
                    <h1 className="text-6xl md:text-7xl font-black bg-gradient-to-r from-white via-amber-200 to-yellow-200 bg-clip-text text-transparent mb-8 leading-tight">
                        Sobre Nosotros
                    </h1>
                    
                    <p className="text-xl md:text-2xl text-gray-100 leading-relaxed max-w-3xl mx-auto">
                        Transformamos experiencias digitales con <span className="text-amber-300 font-semibold">innovación</span>, 
                        <span className="text-yellow-300 font-semibold"> calidad</span> y 
                        <span className="text-blue-300 font-semibold"> pasión</span>
                    </p>
                </div>
                ...
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 mb-16">
                    ...
                    <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 shadow-2xl hover:transform hover:scale-105 transition-all duration-500">
                        <div className="flex items-center gap-4 mb-6">
                            <div className="w-16 h-16 bg-gradient-to-r from-amber-500 to-yellow-500 rounded-2xl flex items-center justify-center">
                ...
                <div className="max-w-6xl mx-auto mb-16">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-300 text-xl">Los principios que guían cada decisión</p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-all duration-300">
                            ...
                            <p className="text-gray-300 text-sm">Búsqueda constante de la perfección en cada detalle</p>
                        </div>
                        ...
                        <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-all duration-300">
                            ...
                            <p className="text-gray-300 text-sm">Trabajo en equipo para lograr objetivos extraordinarios</p>
                        </div>
                        ...
                        <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-all duration-300">
                            ...
                            <p className="text-gray-300 text-sm">Pioneros en soluciones creativas y disruptivas</p>
                        </div>
                        ...
                        <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-all duration-300">
                            ...
                            <p className="text-gray-300 text-sm">Transparencia y honestidad en todas nuestras acciones</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-4xl mx-auto bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 shadow-2xl mb-16">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        <div className="text-center">
                            <div className="text-4xl font-black text-amber-300 mb-2">10K+</div>
                        ...
                        <div className="text-center">
                            ...
                            <div className="text-gray-300 text-sm">Productos Premium</div>
                        </div>
                        <div className="text-center">
                            <div className="text-4xl font-black text-blue-300 mb-2">99.9%</div>
                            <div className="text-gray-300 text-sm">Uptime Garantizado</div>
                        </div>
                        <div className="text-center">
                            <div className="text-4xl font-black text-indigo-300 mb-2">24/7</div>
                ...
                <div className="max-w-3xl mx-auto text-center">
                    <div className="bg-gradient-to-r from-slate-700 to-gray-700 rounded-3xl p-12 shadow-2xl border border-amber-400/20">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <button onClick = {() => 
                                router.push('/product')
                            }className="bg-amber-500 text-white font-bold py-4 px-8 rounded-2xl hover:bg-amber-600 transition-all duration-300 hover:transform hover:scale-105 shadow-lg cursor-pointer">
                                Conoce Nuestros Productos
                            </button>
                            <button className="bg-white/10 backdrop-blur-sm text-white font-bold py-4 px-8 rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-300 hover:transform hover:scale-105">
                                Contáctanos
                            </button>
                        </div>
                    </div>
